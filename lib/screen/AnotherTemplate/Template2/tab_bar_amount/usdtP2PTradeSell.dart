...
class usdtP2PTradeSell extends StatefulWidget {
  final Widget child;

  usdtP2PTradeSell({Key key, this.child}) : super(key: key);

  _usdtP2PTradeSellState createState() => _usdtP2PTradeSellState();
}

class _usdtP2PTradeSellState extends State<usdtP2PTradeSell> {
