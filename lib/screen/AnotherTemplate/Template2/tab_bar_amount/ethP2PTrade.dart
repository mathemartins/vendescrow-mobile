...
class ethP2PTrade extends StatefulWidget {
  final Widget child;

  ethP2PTrade({Key key, this.child}) : super(key: key);

  _ethP2PTradeState createState() => _ethP2PTradeState();
}

class _ethP2PTradeState extends State<ethP2PTrade> {
