...
class ltcP2PTradeSell extends StatefulWidget {
  final Widget child;

  ltcP2PTradeSell({Key key, this.child}) : super(key: key);

  _ltcP2PTradeSellState createState() => _ltcP2PTradeSellState();
}

class _ltcP2PTradeSellState extends State<ltcP2PTradeSell> {
