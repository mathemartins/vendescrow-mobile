...
class dogeP2PTradeSell extends StatefulWidget {
  final Widget child;

  dogeP2PTradeSell({Key key, this.child}) : super(key: key);

  _dogeP2PTradeSellState createState() => _dogeP2PTradeSellState();
}

class _dogeP2PTradeSellState extends State<dogeP2PTradeSell> {
