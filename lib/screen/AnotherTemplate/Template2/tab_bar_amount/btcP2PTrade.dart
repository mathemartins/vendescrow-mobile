...
class btcP2PTrade extends StatefulWidget {
  final Widget child;

  btcP2PTrade({Key key, this.child}) : super(key: key);

  _btcP2PTradeState createState() => _btcP2PTradeState();
}

class _btcP2PTradeState extends State<btcP2PTrade> {
