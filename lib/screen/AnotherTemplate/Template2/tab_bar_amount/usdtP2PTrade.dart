...
class usdtP2PTrade extends StatefulWidget {
  final Widget child;

  usdtP2PTrade({Key key, this.child}) : super(key: key);

  _usdtP2PTradeState createState() => _usdtP2PTradeState();
}

class _usdtP2PTradeState extends State<usdtP2PTrade> {
