...
class dogeP2PTrade extends StatefulWidget {
  final Widget child;

  dogeP2PTrade({Key key, this.child}) : super(key: key);

  _dogeP2PTradeState createState() => _dogeP2PTradeState();
}

class _dogeP2PTradeState extends State<dogeP2PTrade> {
