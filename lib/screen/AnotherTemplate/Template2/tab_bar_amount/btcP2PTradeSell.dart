...
class btcP2PTradeSell extends StatefulWidget {
  final Widget child;

  btcP2PTradeSell({Key key, this.child}) : super(key: key);

  _btcP2PTradeSellState createState() => _btcP2PTradeSellState();
}

class _btcP2PTradeSellState extends State<btcP2PTradeSell> {
