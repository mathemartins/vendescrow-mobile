...
import 'package:crypto_v2/screen/AnotherTemplate/Template2/tab_bar_amount/btcP2PTradeSell.dart';
import 'package:crypto_v2/screen/AnotherTemplate/Template2/tab_bar_amount/dogeP2PTrade.dart';
import 'package:crypto_v2/screen/AnotherTemplate/Template2/tab_bar_amount/dogeP2PTradeSell.dart';
import 'package:crypto_v2/screen/AnotherTemplate/Template2/tab_bar_amount/ethP2PTrade.dart';
import 'package:crypto_v2/screen/AnotherTemplate/Template2/tab_bar_amount/ethP2PTradeSell.dart';
import 'package:crypto_v2/screen/AnotherTemplate/Template2/tab_bar_amount/ltcP2PTrade.dart';
import 'package:crypto_v2/screen/AnotherTemplate/Template2/tab_bar_amount/ltcP2PTradeSell.dart';
import 'package:crypto_v2/screen/AnotherTemplate/Template2/tab_bar_amount/usdtP2PTrade.dart';
import 'package:crypto_v2/screen/AnotherTemplate/Template2/tab_bar_amount/usdtP2PTradeSell.dart';
import 'package:crypto_v2/screen/setting/themes.dart';
import 'package:flutter/material.dart';

class T2_home_sell extends StatefulWidget {
  /// Get data bloc from
  ThemeBloc themeBloc;
  final Widget child;
  final String transactionType;

  T2_home_sell({Key key, this.themeBloc, this.child, this.transactionType}) : super(key: key);

  @override
  _T2_home_sellState createState() => _T2_home_sellState(themeBloc);
}

class _T2_home_sellState extends State<T2_home_sell> with SingleTickerProviderStateMixin {
  ...
  ThemeBloc themeBloc;
  _T2_home_sellState(this.themeBloc);
  bool theme = true;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: Theme.of(context).scaffoldBackgroundColor,
      body: TabBarView(
        children: <Widget>[usdtP2PTradeSell(), btcP2PTradeSell(), ethP2PTradeSell(), ltcP2PTradeSell(), dogeP2PTradeSell()],
        controller: _tabController,
      ),
    );
  }
