...
class T4_payment extends StatefulWidget {
  ...
  T4_payment({Key key, this.tradeInfo, this.transactionType}) : super(key: key);
...
class _T4_paymentState extends State<T4_payment> {
  ...
  TextEditingController _amountToBuyController = TextEditingController();
              ...
              children: <Widget>[
                ...
                Padding(padding: const EdgeInsets.only(top: 70.0, left: 20.0),
                  child: Row(children: <Widget>[
                    ...
                    Text(
                      'Buy ${widget.tradeInfo.assetToTrade} from ${widget.tradeInfo.tradeCreatorUsername}',
                      style: TextStyle(
                  ...
                  children: [
                    Padding(padding: const EdgeInsets.only(top: 20.0, left: 10.0, right: 10.0),
                      child: new TextFormField(
                        controller: _amountToBuyController,
                        ...
                        decoration: InputDecoration(
                            labelText: "Enter amount to buy in ${getUserCurrencyName(_blackMarketRate.country)}",
                    ...
                    transactionsDetail(_amountToBuyController.text, cryptoValueDetail.quote.uSD.price, double.parse(widget.tradeInfo.creatorRateInDollar), _blackMarketRate, widget.tradeInfo.assetToTrade),
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              "Buy ${widget.tradeInfo.assetToTrade}",
                              style: TextStyle(
                                color: Colors.white,
                                fontFamily: 'avenir',
  ...
  processTrade(transactionType) {
    if (validateAndSave()) {
      Map payload  = {"trade": widget.tradeInfo.slug, "tradeCustomer": user.username, "unitsOfAsset": getTradeAssetUnit(_amountToBuyController.text, cryptoValueDetail.quote.uSD.price, double.parse(widget.tradeInfo.creatorRateInDollar)), "fiatToBePaid": _amountToBuyController.text, "status": "CREATED AND RUNNING", "currency": getUserCurrency(_blackMarketRate.country), "slug": "${widget.tradeInfo.slug}-${user.slug}-${user.username}", "actionType": 1};
      print(payload);
      setState(() {
      ...
      apiService.post('p2p/create/transaction/$transactionType/', payload).then((value) {
        ...
        if (value['message'].toString().contains("Successfully")) {
          ...
          Navigator.of(context).push(PageRouteBuilder(pageBuilder: (_, __, ___) => T4_banking(
