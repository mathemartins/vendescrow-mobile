...
import 'package:crypto_v2/component/P2PTrade/P2PTradeRetrieveBuyTransactionModel.dart';
...
class T4_banking_sell extends StatefulWidget {
  ...
  T4_banking_sell({Key key, this.narration, this.tradeInfo, this.customer, this.cryptoValueDetail, this.p2pTradeSettings, this.transactionType}) : super(key: key);

  _T4_banking_sellState createState() => _T4_banking_sellState();
}

class _T4_banking_sellState extends State<T4_banking_sell> {
  ThemeBloc _themeBloc;
  final scaffoldKey = GlobalKey<ScaffoldState>();
  APIService apiService = new APIService();
  P2PTradeBuyTransactionRetrieve _transactionRetrieve = new P2PTradeBuyTransactionRetrieve();
  ...
  void fetchPageData(String tradeSlug, String transactionKey, String transactionType) async {
    ...
    setState(() {
      _transactionRetrieve = P2PTradeBuyTransactionRetrieve.fromJson(responseData['data'][0]);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            ///
            card("assets/image/Template_3/deals_layout/giveMenu.png","Tap to call ${widget.tradeInfo.tradeCreatorUsername} ", "", "", "${_transactionRetrieve.tradeCreatorPhone}"),
            card("assets/image/Template_3/deals_layout/moneyMenu.png","User Will Transfer", "", "${Helper.getFormattedFiat(_transactionRetrieve.fiatPaid, _blackMarketRate.country)}", "${_transactionRetrieve.tradeCreatorPhone}"),
            card("","${widget.narration}", "", "Tap to call", "${_transactionRetrieve.tradeCreatorPhone}"),
            ...
            child: GestureDetector(
              onTap: () async {
                ...
                APIService apiService = new APIService();
                apiService.post("p2p/create/transaction/buy/", data).then((value) {
                  setState(() {
