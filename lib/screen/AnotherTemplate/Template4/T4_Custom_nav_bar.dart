...
class T4_BottomNavigationDotBar extends StatefulWidget{
  ...
  const T4_BottomNavigationDotBar({@required this.items, this.activeColor, this.color, Key key}): super(key: key);
...
class _T4_BottomNavigationDotBarState extends State<T4_BottomNavigationDotBar>{
  ...
  List<_NavigationIconButton> _createNavigationIconButtonList(Map<int, T4_BottomNavigationDotBarItem> mapItem){
...
class T4_BottomNavigationDotBarItem{
  ...
  const T4_BottomNavigationDotBarItem({@required this.icon, this.onTap}) : assert(icon != null);
}
