...
class T1_all extends StatefulWidget {
  @override
  _T1_allState createState() => _T1_allState();
}

class _T1_allState extends State<T1_all> {
  ...
  void initState() {
    ...
    apiService.getP2PTransactionListPerUser().then((value) {
      setState(() {
        p2pTradeCompleted.addAll(value.reversed.toList());
        loadData = false;
      });
    });
  }
