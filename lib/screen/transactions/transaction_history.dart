...
//
// class assetTransactionHistory extends StatefulWidget {
//   final String asset;
//
//   assetTransactionHistory({Key key, this.asset}) : super(key: key);
//
//   _assetTransactionHistoryState createState() => _assetTransactionHistoryState();
// }
//
// class _assetTransactionHistoryState extends State<assetTransactionHistory> {
...
//   List<CryptoTransactions> transactionList = List<CryptoTransactions>();
...
//   void initState() {
//     super.initState();
//     apiService.getTransactionListData().then((value) {
//       setState(() {
//         transactionList.addAll(value.where((element) => element.asset.toLowerCase() == widget.asset).toList());
